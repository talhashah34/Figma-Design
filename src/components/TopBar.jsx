...
const TopBar = () => {
  return (
    <div className='flex flex-row items-center max-w-[1440px] max-h-[90px] 
    mx-[130px] py-[42px] text-sans text-secondary'>
      ...
      <div className='w-[507px] h-[48px] bg-[#F3F9FB] text-[14px] rounded-[10px] mx-auto
      flex flex-row items-center justify-between px-[18px] gap-2 
      '>
      ...
      <div className='w-[241px] h-[24px] flex flex-row items-center text-[16px] mr-[25px]
      '>
